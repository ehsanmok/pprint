...
def test_int_large() raises:
    """Large integer."""
    assert_equal(pformat(999999999), "999999999")


def test_int_small() raises:
    """Small integer."""
    assert_equal(pformat(1), "1")


def test_int_max() raises:
    """Very large integer."""
...
def test_bool_with_type() raises:
...
def test_string_with_type() raises:
...
def test_float_with_type() raises:
